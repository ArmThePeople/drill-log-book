...
\begin{document}
	...
	\begin{minipage}[t][0.85\textheight][t]{\textwidth}
		...
		\begin{tabular}{|p{0.1\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.182\textwidth}|}
			\hline
			\rowcolor[HTML]{C0C0C0} 
